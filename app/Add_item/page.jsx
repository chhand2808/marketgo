...
export default function Page() {
  ...
  return (
    ...
    <div className="flex w-full items-center justify-start bg-gray-50">
      <div className='flex flex-col w-full m-10'>
        <h1 className="font-bold text-4xl mb-5">Add Item</h1>
        <div className="flex gap-2 py-10 px-8 bg-white rounded-md border-t-4 border-purple-400">
